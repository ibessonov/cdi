...
import com.github.ibessonov.cdi.util.CollectionUtil;

import java.lang.annotation.Annotation;
import java.lang.reflect.*;
import java.util.*;

import static com.github.ibessonov.cdi.enums.CdiErrorType.*;
...
final class InheritorGenerator {
    ...
    public ClassInfo getClassInfo(Class<?> clazz) {
        ...
        for (Method method : ci.x.declaredMethods) {
            ...
            //TODO this code is copy-pasted in "implement" method
